...
{
	pObjCore->m_X = round_my(m_Pos.x);
	pObjCore->m_Y = round_my(m_Pos.y);

	pObjCore->m_VelX = round_my(m_Vel.x*256.0f);
	pObjCore->m_VelY = round_my(m_Vel.y*256.0f);
	pObjCore->m_HookState = m_HookState;
	pObjCore->m_HookTick = m_HookTick;
	pObjCore->m_HookX = round_my(m_HookPos.x);
	pObjCore->m_HookY = round_my(m_HookPos.y);
	pObjCore->m_HookDx = round_my(m_HookDir.x*256.0f);
	pObjCore->m_HookDy = round_my(m_HookDir.y*256.0f);
